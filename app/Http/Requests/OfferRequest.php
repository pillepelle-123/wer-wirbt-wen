...
class OfferRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'reward_split_percent' => 'required|numeric|between:0.01,1.00',
            'status' => [
                'required',
    ...
    public function messages()
    {
        return [
            ...
            'offered_by.required' => 'Bitte angeben, von wem das Angebot kommt.',
            'offered_by.in' => 'Ungültige Auswahl. Muss "Referrer" oder "Referred" sein.',
            ...
            'reward_split_percent.required' => 'Bitte den Aufteilungsprozentsatz angeben.',
            'reward_split_percent.numeric' => 'Der Prozentsatz muss eine Zahl sein.',
            'reward_split_percent.between' => 'Der Prozentsatz muss zwischen 1% und 100% liegen.',
